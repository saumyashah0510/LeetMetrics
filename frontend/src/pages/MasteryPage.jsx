          ...
          {isLoading ? (
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-[#282828] border border-[#3d3d3d]/50 rounded-xl p-6 lg:col-span-2 flex flex-col h-[450px]">
                  ...
                  <div className="flex-1 w-full relative">
                    {/* Quadrant Labels */}
                    <div className="absolute top-4 left-14 text-[#8c8c8c]/30 font-bold text-lg pointer-events-none uppercase tracking-widest z-0">Snipers</div>
                    <div className="absolute top-4 right-8 text-[#00b8a3]/20 font-bold text-lg pointer-events-none uppercase tracking-widest z-0 text-right">Masters</div>
                    <div className="absolute bottom-10 left-14 text-[#ef4743]/20 font-bold text-lg pointer-events-none uppercase tracking-widest z-0">Beginners</div>
                    <div className="absolute bottom-10 right-8 text-[#ffa116]/20 font-bold text-lg pointer-events-none uppercase tracking-widest z-0 text-right">Grinders</div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <ScatterChart margin={{ top: 30, right: 30, bottom: 30, left: 10 }}>
                        ...
                        <XAxis 
                          ...
                          tickLine={false} 
                          axisLine={false}
                          label={{ value: "Volume", position: "bottom", fill: "#8c8c8c", fontSize: 12, dy: 10 }}
                        />
                        <YAxis 
                          type="number" 
                          dataKey="y" 
                          ...
                          tickLine={false} 
                          axisLine={false}
                          label={{ value: "Difficulty", angle: -90, position: "insideLeft", fill: "#8c8c8c", fontSize: 12, dx: -10 }}
                        />
                        <ZAxis type="number" dataKey="z" range={[40, 400]} />
                        <RechartsTooltip cursor={{ strokeDasharray: '3 3' }} content={<ScatterTooltip />} />
                        <ReferenceLine x={25} stroke="#4a4a4a" strokeDasharray="3 3" />
                        <ReferenceLine y={25} stroke="#4a4a4a" strokeDasharray="3 3" />
                        <Scatter name="Patterns" data={scatterData} fill="#ffa116" fillOpacity={0.7}>
                          {
                ...
                <div className="bg-[#282828] border border-[#3d3d3d]/50 rounded-xl p-6 flex flex-col h-full">
